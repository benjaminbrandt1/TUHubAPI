...
public final class find_005fproducts_005fby_005fuser_005fid_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    if (request.getParameter(userIdKey) != null) {
        ...
        if(request.getParameter(numRowsKey) != null){
            ...
            if (msg.length() == 0) { // got open connection
                ProductList productList = ProductSearch.getProductsByUserId(dbc, id, start, numRows);
