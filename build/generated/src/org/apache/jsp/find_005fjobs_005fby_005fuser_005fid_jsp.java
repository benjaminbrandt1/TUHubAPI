...
public final class find_005fjobs_005fby_005fuser_005fid_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    String numRowsKey = "numRows";
    String id;
    String numRows = "10000000000";
    String start = "0";
    Gson gson = new Gson();
    ...
    if (request.getParameter(userIdKey) != null) {
        ...
        if(request.getParameter(numRowsKey) != null){
            ...
            if (msg.length() == 0) { // got open connection
                JobList jobList = JobSearch.getJobsByUserId(dbc, id, start, numRows);
