...
public final class search_005factive_005fpersonal_005ftitles_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    if (request.getParameter(numRowsKey) != null && request.getParameter(numRowsKey).length() != 0) {
        numRows = request.getParameter(numRowsKey);
            ...
            if (msg.length() == 0) { // got open connection
                PersonalList personalList = PersonalSearch.searchActivePersonalTitles(dbc, title, start, numRows);
