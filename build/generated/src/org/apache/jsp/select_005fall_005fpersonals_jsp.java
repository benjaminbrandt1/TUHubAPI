...
public final class select_005fall_005fpersonals_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (error.length() == 0) {
        ...
        if (error.length() == 0) { // got open connection
            PersonalList personalList = PersonalSearch.getAllPersonalList(dbc, activeOnly, start, numRows);
